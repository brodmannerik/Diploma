"""
Due to a bug in one of these 10-meter cables from DPI to HDMI,
the resolution of the main screen keeps changing.
This file fixes this specific issue.
...
class UnrealWindowManager:
    ...
    def __init__(self, borderless: bool = True, hide_titlebar: bool = True):
        ...
        self.positions = [
            (0, 0, 600, 800),      # Display 0: Leftmost (now 600x800)
            (600, 0, 480, 800),    # Display 1: Second from left
            (1080, 0, 480, 800),   # Display 2: Third from left
            (1560, 0, 480, 800)    # Display 3: Rightmost
        ]
